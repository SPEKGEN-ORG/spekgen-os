#!/usr/bin/env python3
"""Publish LF April 2026 report to spekgen.com/lf-reporte-abril."""
...
HTML_PATH = SKILL_DIR / "reports" / "lf-reporte-abril.html"
HANDLE_BASE = "lf-reporte-abril"
TITLE = "LO FITNESS · Reporte Abril 2026"

print(f"[1/4] Leyendo HTML ({HTML_PATH.stat().st_size // 1024} KB)")
html = HTML_PATH.read_text(encoding="utf-8")

print("[2/4] Preparando para Shopify (namespace fixes + chrome hider)")
